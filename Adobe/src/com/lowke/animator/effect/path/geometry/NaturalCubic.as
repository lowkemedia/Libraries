package com.lowke.animator.effect.path.geometry
{
    ...
    public class NaturalCubic
    {
         ...
         * @param   controlPoints a Vector of the control points
         * @param   closed a boolean to tell wether the curve is opened or closed
         * @return a Vector of the x/y couple values of the cubic spline
         */
            ...
            if ( controlPoints.length >= 2) 
            {
                ...
                for ( i = 0; i < X.length; i++) 
                {
                    for ( j = 1; j <= _steps; j++) 
                    {
                        ...
                        p.push( X[i].eval(u), Y[i].eval(u) );       // we needed real numbers here rather than integers
        ...
        */
        ...
        /**
         * retrieves the curve as a Vector
         */
        ...
        /**
         * retrieves the curve as a Vector set of x/y couple values
         */
        public function get curveAsValues( ):Vector.<Number>
        {
            ...
            if ( _points.length == _controlPoints.length ) 
            {
                _points = compute(controlPoints, closed);
            }
